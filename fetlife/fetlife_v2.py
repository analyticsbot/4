...
##proxy = args.proxy
IMAGES_FOLDER = 'C:\\Users\\Ravi Shankar\\Documents\\Upwork\\fetlife\\images'
    ...
    try:
        ...
        for website in Websites:
            ...
            if not user_exists:
                ...
                con.execute(meta.tables['websites'].update().where(users.c.id == int(user_id)), website_details)
    except Exception,e:
        print str(e)
        pass
    ...
    try:
        ...
        for group in Groups_member_of:
            ...
            if not user_exists:
                ...
                con.execute(meta.tables['groups'].update().where(users.c.id == int(user_id)), group_details)
    except:
        pass
        ...
        try:
            ...
            for value in values:
                ...
                if not user_exists:
                    ...
                    con.execute(meta.tables['fetishes'].update().where(users.c.id == int(user_id)), fetish_details)
        except:
            pass
