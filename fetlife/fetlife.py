...
def getUserDetails(user_url, info, location, username):
    ...
    user_details = {'Most_recent_date_updated':Most_recent_date_updated, 'Date_first_crawled':Date_first_crawled,\
                    ...
                    'D_s_Relationships_pet':D_s_Relationships_pet, 'nickname':nickname,'url':url,'age':age,'role':role,'gender':gender,'Location_Country':Location_Country,'Location_Administrative_area':Location_Administrative_area,'Location_City':Location_City,'Sexual_Orientation':Sexual_Orientation,'How_active':How_active,'Looking_for_A_Lifetime_Relationship_LTR':Looking_for_A_Lifetime_Relationship_LTR,'Looking_for_A_Relationship':Looking_for_A_Relationship,'Looking_for_A_Mentor_Teacher':Looking_for_A_Mentor_Teacher,'Looking_for_Someone_To_Play_With':Looking_for_Someone_To_Play_With,'Looking_for_A_Princess_By_Day_Slut_By_Night':Looking_for_A_Princess_By_Day_Slut_By_Night,'Looking_for_Friendship':Looking_for_Friendship,'Looking_for_A_Master':Looking_for_A_Master,'Looking_for_A_Mistress':Looking_for_A_Mistress,'Looking_for_A_sub':Looking_for_A_sub,'Looking_for_A_slave':Looking_for_A_slave,'Looking_for_Events':Looking_for_Events,'Looking_for_None':Looking_for_None,'D_s_Relationships_Dominant':D_s_Relationships_Dominant,'D_s_Relationships_Sadist':D_s_Relationships_Sadist,'D_s_Relationships_Sadomasochist':D_s_Relationships_Sadomasochist,'D_s_Relationships_Master':D_s_Relationships_Master,'D_s_Relationships_Mistress':D_s_Relationships_Mistress,'D_s_Relationships_Owner':D_s_Relationships_Owner,'D_s_Relationships_Master_and_Owner':D_s_Relationships_Master_and_Owner,'D_s_Relationships_Mistress_and_Owner':D_s_Relationships_Mistress_and_Owner,'D_s_Relationships_Top':D_s_Relationships_Top,'D_s_Relationships_Daddy':D_s_Relationships_Daddy,'D_s_Relationships_Mommy':D_s_Relationships_Mommy,'D_s_Relationships_Brother':D_s_Relationships_Brother,'D_s_Relationships_Sister':D_s_Relationships_Sister,'D_s_Relationships_Being_Served':D_s_Relationships_Being_Served,'D_s_Relationships_Considering':D_s_Relationships_Considering,'D_s_Relationships_Protecting':D_s_Relationships_Protecting,'D_s_Relationships_Mentoring':D_s_Relationships_Mentoring,'D_s_Relationships_Teaching':D_s_Relationships_Teaching,'D_s_Relationships_Training':D_s_Relationships_Training,'D_s_Relationships_Switches':D_s_Relationships_Switches,'D_s_Relationships_submissive':D_s_Relationships_submissive,'D_s_Relationships_masochist':D_s_Relationships_masochist,'D_s_Relationships_bottom':D_s_Relationships_bottom,'D_s_Relationships_owned_and_collared':D_s_Relationships_owned_and_collared,'D_s_Relationships_owned':D_s_Relationships_owned,'D_s_Relationships_property':D_s_Relationships_property,'D_s_Relationships_collared':D_s_Relationships_collared,'D_s_Relationships_slave':D_s_Relationships_slave,'D_s_Relationships_kajira':D_s_Relationships_kajira,'D_s_Relationships_kajirus':D_s_Relationships_kajirus,'D_s_Relationships_in_service':D_s_Relationships_in_service,'D_s_Relationships_under_protection':D_s_Relationships_under_protection,'D_s_Relationships_under_consideration':D_s_Relationships_under_consideration}
