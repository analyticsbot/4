...
def getUserDetails(user_url, info, location, username, con, meta, user_exists, websites, fetishes, groups, pictures):
    ...
    try:
        ...
        for i in s:
            ...
            if newonly == 1 and user_exists:
                ...
                getUserDetails(user_url, info, location, username, con, meta, user_exists, websites, fetishes, groups, pictures)
