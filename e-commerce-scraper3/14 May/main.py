...
df_babyoye = df_urls.query('Shop == "www.babyoye.com"')[:30]
df_fabfurnish = df_urls.query('Shop == "www.fabfurnish.com"')[:30]
df_infibeam = df_urls.query('Shop == "www.infibeam.com"')[:30]
df_jabong = df_urls.query('Shop == "www.jabong.com"')[:30]
df_paytm = df_urls.query('Shop == "www.paytm.com"')[:30]
df_pepperfry = df_urls.query('Shop == "www.pepperfry.com"')[:30]
df_snapdeal = df_urls.query('Shop == "www.snapdeal.com"')[:30]
