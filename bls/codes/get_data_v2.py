...
##                    
        ...
        ##fetch columns
        try:
            results = meta.tables['data_table']
            existing_cols = []
...
####                    query = "ALTER TABLE data_table ADD " + c + " VARCHAR (500);"
####                elif str(df[c].dtype)=='float64':
####                    query = "ALTER TABLE data_table ADD " + c + " FLOAT;"
####                elif str(df[c].dtype)=='int64':
####                    query = "ALTER TABLE data_table ADD " + c + " INT;"
####                else:
########                    #sprint str(df['footnote_codes'].dtype)
####                    query = "ALTER TABLE data_table ADD " + c + " VARCHAR (5000);"
####                if c in ['footnote_codes', 'footnote_text']:
                query = "ALTER TABLE data_table ADD " + c + " VARCHAR (5000);"
                #print query
                try:
                    ...
                    pass
        try:
            df.to_sql(name='data_table', con=engine, if_exists = 'append', index=False, schema = 'dbo', flavor = 'mssql')
