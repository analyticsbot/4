...
def equationsLR(ScenarioSetId, numEqn, allmonth, maxvars):
    ...
    """
##    connection_string = "DRIVER={SQL Server};SERVER=s20160720075427.rds-am1-np.aws.shell-cloud.com;UID=primeone;PWD=Primeone@1;DATABASE=Primeone;"
...
##    df = psql.read_sql(sql, connection)
    df = pd.read_csv('MLScenarioSetProdCurveDetail.csv')
    ...
    for eod in eods:
        ...
        print df.shape, df.columns, new_df.shape, new_df.columns, \
              len(values), eod
        # value_dict = {}
